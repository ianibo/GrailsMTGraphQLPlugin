 ...
 */
@Slf4j
class PersistentClassUpdateMutation implements DataFetcher {

  private org.grails.datastore.mapping.model.PersistentEntity domainClass = null;

  public PersistentClassUpdateMutation() {
  }

  public PersistentClassUpdateMutation(org.grails.datastore.mapping.model.PersistentEntity domainClass) {
